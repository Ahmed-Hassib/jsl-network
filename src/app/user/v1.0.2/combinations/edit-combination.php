        ...
        <form class="py-3 my-5 custom-form needs-validation" action="?do=updateCombination" method="POST" enctype="multipart/form-data">
            ...
            <div class="my-3 row g-3">
                <div class="ms-auto col-sm-2">
                    <button type="submit" class="btn btn-primary text-capitalize form-control bg-gradient <?php if ($_SESSION['comb_update'] == 0) {echo 'disabled';} ?>" id="">
                        <i class="bi bi-check-all"></i>
                        <?php echo language('SAVE CHANGES', $_SESSION['systemLang']) ?>
                    </button>
                </div>
                <div class="col-sm-2">
                    <button type="button" class="btn btn-outline-danger text-capitalize form-control bg-gradient <?php if ($_SESSION['comb_delete'] == 0) {echo 'disabled';} ?>" data-bs-toggle="modal" data-bs-target="#deleteCombModal">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h2 class="h2" <?php echo $_SESSION['systemLang'] == "ar" ? "dir=rtl" : ""; ?>><?php echo language('ARE YOU SURE TO DELETE', $_SESSION['systemLang'])." ".language('THE COMBINATION', $_SESSION['systemLang'])." ".( $_SESSION['systemLang'] == "ar" ? "؟" : "?" )?> </h2>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <a href="?do=deleteComb&combid=<?php echo $combrows['comb_id'] ?>" class="btn btn-danger text-capitalize <?php if ($_SESSION['comb_delete'] == 0) {echo 'disabled';} ?>"><i class="bi bi-trash"></i>&nbsp;<?php echo language('DELETE', $_SESSION['systemLang']) ?></a>
                    </div>
                </div>
            </div>
        </div>
