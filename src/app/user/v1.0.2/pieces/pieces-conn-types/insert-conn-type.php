...
<div class="container" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    ...
    <header class="header mb-3">
        ...
        <h5 class="h5 text-capitalize text-secondary "><?php echo language('ADD NEW CONNECTION TYPE', $_SESSION['systemLang']) ?></h6>        
        ...
        <?php
            ...
            if (!empty($connTypeName)) {
                ...
                if (checkItem("`conn_name`", "`conn_types`", $connTypeName) > 0) {
                    // echo danger message
                    ...
                    // insert query
                    $q = "INSERT INTO `conn_types` (`conn_name`, `notes`) VALUES (?, ?);";
                    $stmt = $con->prepare($q);
                    $stmt->execute(array($connTypeName, $connTypeNote));
