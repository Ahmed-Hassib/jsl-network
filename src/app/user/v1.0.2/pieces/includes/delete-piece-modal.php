    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 500px" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="h4  text-danger"><?php echo language('ARE YOU SURE TO DELETE', $_SESSION['systemLang'])." '" .$row['piece_name']. "' ". ($_SESSION['systemLang'] == "ar" ? "؟" : "?") ?> </h4>
            </div>
            <div class="modal-footer">
                <a href="?do=deletePiece&pieceid=<?php echo $row['piece_id'] ?>" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'ltr' : 'rtl' ?>" class="btn btn-danger text-capitalize <?php if ($_SESSION['pcs_delete'] == 0) {echo 'd-none';} ?>"><i class="bi bi-trash"></i>&nbsp;<?php echo language('DELETE', $_SESSION['systemLang']) ?></a>
