    ...
    <div class="modal-dialog modal-dialog-centered modal-type-dialog" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
        <div class="modal-content">
                ...
                <form action="?do=piecesTypes&action=deletePieceType" method="POST" id="deletePieceType">
                    ...
                    <div class="mb-sm-2 mb-md-3 row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <?php $typesRows = selectSpecificColumn("*", "`types`", "WHERE `type_id` <> 4"); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger py-1 fs-12" form="deletePieceType" onclick="validateForm(this.form)"><i class="bi bi-trash"></i><?php echo language("DELETE", $_SESSION['systemLang']) ?></button>
