...
if ($query == 'ping') {
    ...
    // include search file
    include_once $curr_version . '/requests/get-sources.php';


} elseif ($query == "search") {
    
    // include search file
    include_once $curr_version . '/requests/search-clients.php';
    ...
    include_once $curr_version . '/requests/get-user-info.php';

} elseif ($query == "updateSession") {
    
    // include update session file
    include_once $curr_version . '/requests/update-session.php';
    ...
    // include update session file
    include_once $curr_version . '/requests/upgrade-version.php';
