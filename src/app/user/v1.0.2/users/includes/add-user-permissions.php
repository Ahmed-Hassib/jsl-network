...
<div class="mb-4 row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="row row-cols-sm-1 row-cols-md-3 row-cols-lg-5 align-items-start g-sm-1 gx-md-5">
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="suggReplay" id="suggReplay">
            ...
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="suggDelete" id="suggDelete">
            ...
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="suggShow" id="suggShow">
...
<div class="mb-4 row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="row row-cols-sm-1 row-cols-md-3 row-cols-lg-5 align-items-start g-sm-1 gx-md-5">
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="pointsAdd" id="pointsAdd">
            ...
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="pointsDelete" id="pointsDelete">
            ...
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="pointsShow" id="pointsShow">
...
<div class="mb-4 row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="row row-cols-sm-1 row-cols-md-3 row-cols-lg-5 align-items-start g-sm-1 gx-md-5">
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="reportsShow" id="reportsShow">
...
<div class="mb-4 row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="row row-cols-sm-1 row-cols-md-3 row-cols-lg-5 align-items-start g-sm-1 gx-md-5">
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="archiveShow" id="archiveShow">
...
<div class="mb-4 row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="row row-cols-sm-1 row-cols-md-2 align-items-start g-sm-1 gx-md-5 align-item-center">
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="1" name="takeBackup" id="takeBackup">
            ...
            <div class="col-sm-12">
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input" type="checkbox" value="1" name="restoreBackup" id="restoreBackup">
                </div>
            </div>
        </div>
    </div>
