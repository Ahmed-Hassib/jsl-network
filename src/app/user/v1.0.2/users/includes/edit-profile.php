<!-- start edit profile -->
<div class="mt-3 row row-cols-sm-1 row-cols-lg-2 g-3">
    ...
    <form class="profile-form" action="?do=update" method="POST" id="editUser">
                ...
                <div class="section-block">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            ...
                            <!-- <div id="passHelp" class="form-text">Password must be hard and complex.</div> -->
                        </div>
                    </div>
                    <!-- end user name field -->
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            <input type="text" class="form-control" name="address" id="address" aria-describedby="address" value="<?php echo $row['address'] ?>" placeholder="<?php echo language('NO DATA ENTERED', $_SESSION['systemLang']) ?>" <?php if ($_SESSION['user_update'] == 0 && $_SESSION['UserID'] != $row['UserID']) {echo 'readonly';} ?> required>
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="section-block">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            <input type="email" class="form-control" name="email" id="email" placeholder="example@example.com" aria-describedby="emailHelp" value="<?php echo $row['Email'] ?>"  <?php if ($_SESSION['user_update'] == 0 && $_SESSION['UserID'] != $row['UserID']) {echo 'readonly';} ?> required>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            <input type="text" maxlength="11" class="form-control" name="phone" id="phone" placeholder="<?php echo language('NO DATA ENTERED', $_SESSION['systemLang']) ?>" value="<?php echo $row['phone'] ?>" <?php if ($_SESSION['user_update'] == 0 && $_SESSION['UserID'] != $row['UserID']) {echo 'readonly';} ?> required>
                        </div>
                    </div>
                    <!-- end phone field -->
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            <input type="date" class="form-control px-5" name="date-of-birth" id="date-of-birth"  value="<?php echo $row['date_of_birth'] ?>" <?php if ($_SESSION['user_update'] == 0 && $_SESSION['UserID'] != $row['UserID']) {echo 'readonly';} ?> required>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="section-block">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            <input type="text" name="job-title" id="job-title" class="form-control" value="<?php echo $row['job_title'] ?>" placeholder="<?php echo language('NO DATA ENTERED', $_SESSION['systemLang']) ?>" required>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="section-block">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control border-primary <?php echo $_SESSION['systemLang'] == 'ar' ? 'form-control-left' : 'form-control-right' ?>" name="twitter"  value="<?php echo $row['twitter'] ?>" placeholder="<?php echo language('NO DATA ENTERED', $_SESSION['systemLang']) ?>" aria-label="twitter" aria-describedby="twitter">
                    </div>
                    <!-- end twitter field -->
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control border-primary <?php echo $_SESSION['systemLang'] == 'ar' ? 'form-control-left' : 'form-control-right' ?>" name="facebook" value="<?php echo $row['facebook'] ?>"  placeholder="<?php echo language('NO DATA ENTERED', $_SESSION['systemLang']) ?>" aria-label="facebook" aria-describedby="facebook">
                    </div>
                    <!-- end facebook field -->
        ...
        <div class="hstack gap-3">
            <div class="<?php echo $_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
                <!-- edit button -->
                <button type="button" form="editUser" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'ltr' : 'rtl' ?>" class="btn btn-primary text-capitalize" <?php if ($_SESSION['user_update'] == 0 && $row['UserID'] != $_SESSION['UserID']) {echo 'disabled';} ?> onclick="validateForm(this.form)"><i class="bi bi-check-all"></i>&nbsp;<?php echo language('SAVE CHANGES', $_SESSION['systemLang']) ?></button>
                
                <?php if ($row['isRoot'] != 1 && $_SESSION['user_delete'] == 1) { ?>
                    <!-- delete button -->
                    <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUserModal" onclick="showUserModal(this)" data-username="<?php echo $row['UserName'] ?>" data-userid="<?php echo $row['UserID'] ?>" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'ltr' : 'rtl' ?>" class="btn btn-outline-danger text-capitalize" <?php if ($_SESSION['user_delete'] == 0 && $row['UserID'] != $_SESSION['UserID']) {echo 'disabled';} ?>><i class="bi bi-trash"></i>&nbsp;<?php echo language('DELETE', $_SESSION['systemLang']) ?></button>
                <?php } ?>
            </div>
        </div>
        <!-- end submit -->
