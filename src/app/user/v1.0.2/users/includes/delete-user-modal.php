    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 500px">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="delete-user" class="btn btn-danger text-capitalize <?php if ($_SESSION['user_delete'] == 0) {echo 'disabled';} ?>" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'ltr' : 'rtl' ?>"><i class="bi bi-trash"></i>&nbsp;<?php echo language('DELETE', $_SESSION['systemLang']) ?></a>
            </div>
        </div>
    </div>
</div>