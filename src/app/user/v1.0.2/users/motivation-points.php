                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUserPointsModal" class='my-1 me-1 btn btn-danger text-capitalize fs-12 <?php if ($_SESSION['points_delete'] == 0) {echo 'disabled';} ?> fs-10-sm' onclick="showUserModal(this)" data-points="<?php echo $point['points'] ?>" data-id="<?php echo $point['id'] ?>"><i class='bi bi-trash'></i><!-- <?php echo language('DELETE', $_SESSION['systemLang']) ?> --></button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
