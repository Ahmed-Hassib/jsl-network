                    ...
                    <div class="mb-sm-2 mb-md-3 row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <?php
                                ...
                                // get all directions 
                                $dirs_data = $dir_obj->get_all_directions($_SESSION['company_id']);
                                $dirRows = $dirs_data[1]; 
                            ?>
                            <select class="form-select" id="updated-dir-name" name="updated-dir-name" onchange="document.getElementById('updated-dir-id').value = this.value; document.getElementById('new-direction-name').value = this[this.selectedIndex].textContent;" required>
