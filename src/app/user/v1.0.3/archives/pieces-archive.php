                        ...
                        <tbody id="piecesTbl" name="pieces">
                            ...
                            <?php foreach ($rows as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="pieces.php?do=editPiece&pieceid=<?php echo $row['piece_id']; ?>">
                                    ...
                                    <td>
                                        <a class="btn btn-success text-capitalize fs-12 <?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="pieces.php?do=editPiece&pieceid=<?php echo $row['piece_id']; ?>" target=""><i class="bi bi-pencil-square"></i><!-- <?php echo language('EDIT', $_SESSION['systemLang']) ?> --></a>
                                        <?php if ($row['type_id'] != 4) { ?>
                                            <a class="btn btn-outline-primary text-capitalize fs-12 <?php if ($_SESSION['pcs_show'] == 0) {echo 'd-none';} ?>" href="?do=showPiece&dirId=<?php echo $row['direction_id'] ?>&srcId=<?php echo $row['piece_id'] ?>" ><i class="bi bi-eye"></i><!-- <?php echo language('SHOW', $_SESSION['systemLang']).' '.language('PIECES', $_SESSION['systemLang']) ?> --></a>
                                        <?php } ?>
                                        <?php if ($row['piece_ip'] != 1) { ?>
                            ...
                            <?php foreach ($rows as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success text-capitalize fs-12 <?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="pieces.php?do=editPiece&pieceid=<?php echo $row['piece_id']; ?>" target=""><i class="bi bi-pencil-square"></i><!-- <?php echo language('EDIT', $_SESSION['systemLang']) ?> --></a>
                                        <?php if ($row['type_id'] != 4) { ?>
                                            <a class="btn btn-outline-primary text-capitalize fs-12 <?php if ($_SESSION['pcs_show'] == 0) {echo 'd-none';} ?>" href="pieces.php?do=showPiece&dirId=<?php echo $row['direction_id'] ?>&srcId=<?php echo $row['piece_id'] ?>" ><i class="bi bi-eye"></i><!-- <?php echo language('SHOW', $_SESSION['systemLang']).' '.language('PIECES', $_SESSION['systemLang']) ?> --></a>
                                        <?php } ?>
                                        <?php if ($row['piece_ip'] != 1) { ?>
                                            <button class="btn btn-outline-secondary text-capitalize fs-12" onclick="ping(this)" value="<?php echo $row['piece_ip']; ?>">ping</button>
                                        <?php } ?>
