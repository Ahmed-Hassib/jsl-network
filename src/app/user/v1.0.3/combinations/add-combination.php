...
<div class="container" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    <!-- start form -->
    <form class="mb-3 custom-form" action="?do=insertCombination" method="POST">
        <!-- horzontal stack -->
        ...
        <div class="hstack gap-2">
            <div class="<?php echo $_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
                <button type="submit" class="btn btn-primary text-capitalize form-control bg-gradient fs-12 <?php if ($_SESSION['comb_add'] == 0 || $emp_counter == 0) {echo 'disabled';} ?>" id="add-malfunctions">
