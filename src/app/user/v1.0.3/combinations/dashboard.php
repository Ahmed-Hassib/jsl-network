                        ...
                        <div class="col-6">
                            <div class="card card-stat bg-total bg-gradient">
                                <div class="card-body">
                                    ...
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=today&combStatus=-1" class="num stretched-link" data-goal="<?php echo $all_comb_today ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-danger bg-gradient">
                                <div class="card-body">
                                    ...
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=today&combStatus=unfinished" class="num stretched-link" data-goal="<?php echo $unfinished_comb_today ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-success bg-gradient">
                                <div class="card-body">
                                    ...
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=today&combStatus=finished" class="num stretched-link" data-goal="<?php echo $finished_comb_today ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-warning bg-gradient">
                                <div class="card-body">
                                    ...
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=today&accepted=delayed" class="num stretched-link" data-goal="<?php echo $delayed_comb_today ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="card card-stat bg-total bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('TOTAL', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=month&combStatus=-1" class="num stretched-link" data-goal="<?php echo $all_comb_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-danger bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('UNFINISHED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=month&combStatus=unfinished" class="num stretched-link" data-goal="<?php echo $unfinished_comb_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-success bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('FINISHED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=month&combStatus=finished" class="num stretched-link" data-goal="<?php echo $finished_comb_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-warning bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('DELAYED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=month&accepted=delayed" class="num stretched-link" data-goal="<?php echo $delayed_comb_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="card card-stat bg-total bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('TOTAL', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=previous-month&combStatus=-1" class="num stretched-link" data-goal="<?php echo $all_comb_prev_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-danger bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('UNFINISHED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=previous-month&combStatus=unfinished" class="num stretched-link" data-goal="<?php echo $unfinished_comb_prev_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-success bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('FINISHED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=previous-month&combStatus=finished" class="num stretched-link" data-goal="<?php echo $finished_comb_prev_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-warning bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('DELAYED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&period=previous-month&accepted=delayed" class="num stretched-link" data-goal="<?php echo $delayed_comb_prev_month ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="card card-stat bg-total bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('TOTAL', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails" class="stretched-link num" data-goal="<?php echo $all_comb ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-danger bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('UNFINISHED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&combStatus=unfinished" class="stretched-link num" data-goal="<?php echo $all_unfinished_comb ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-success bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('FINISHED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&combStatus=finished" class="stretched-link num" data-goal="<?php echo $all_finished_comb ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card card-stat bg-warning bg-gradient">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-capitalize"><?php echo language('DELAYED', $_SESSION['systemLang']) ?></h5>
                                    <span class="nums">
                                        <a href="?do=showCombinationDetails&accepted=delayed" class="stretched-link num" data-goal="<?php echo $all_delayed_comb ?>">0</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <?php foreach ($today_comb as $index => $comb) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 100px">
                                            ...
                                            <a href="<?php echo $nav_up_level ?>users/index.php?do=editUser&userid=<?php echo $comb['UserID'];?>"><?php echo $techName ?></a>
                                        </td>
                                        <td style="width: 50px">
                                            <?php
                                        ...
                                        <td style="width: 50px">
                                            <a href="?do=editCombination&combid=<?php echo $comb['comb_id'] ?>" target="" class="btn btn-outline-primary me-1 fs-12 <?php if ($_SESSION['comb_show'] == 0) {echo 'disabled';} ?>"><i class="bi bi-eye"></i></a>
