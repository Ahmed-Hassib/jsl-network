                                    ...
                                    <div class="col-sm-12 col-lg-8">
                                        <div class="row g-1 justify-content-center align-items-start <?php echo $_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
                                            ...
                                            <?php if ($_SESSION['user_delete'] == 1) { ?>
                                                <!-- user delete button -->
                                                <div class="col-4">
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUserModal" class='w-100 p-1 btn btn-outline-danger text-capitalize fs-12 fs-10-sm' onclick="showUserModal(this)" data-username="<?php echo $row['UserName'] ?>" data-userid="<?php echo $row['UserID'] ?>"><?php echo language('DELETE', $_SESSION['systemLang']) ?></button>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
