    ...
    <header class="header mb-3">
        ...
        <div class="hstack gap-2">
                ...
                <div>
                    ...
                    <a class="btn btn-outline-success fs-12 py-1" href="?name=pieces&do=editPiece&pieceid=<?php echo $srcId; ?>">
            ...
            <tbody id="piecesTbl">
                ...
                <?php foreach ($rows as $row) { ?>
                    ...
                    <tr>
                        ...
                        <!-- piece name -->
                        <td>
                            <a class="<?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="?name=<?php echo $name ?>&do=editPiece&pieceid=<?php echo $row['piece_id']; ?>" target="">
                        ...
                        <!-- control -->
                        <td>
                            <a class="btn btn-success text-capitalize fs-12 <?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="?do=editPiece&pieceid=<?php echo $row['piece_id']; ?>" target=""><i class="bi bi-pencil-square"></i><!-- <?php echo language('EDIT', $_SESSION['systemLang']) ?> --></a>
                            <?php if ($row['is_client'] == 0) { ?>
                                <a class="btn btn-outline-primary text-capitalize fs-12 <?php if ($_SESSION['pcs_show'] == 0) {echo 'd-none';} ?>" href="?name=<?php echo $name ?>&do=showPiece&dirId=<?php echo $row['direction_id'] ?>&srcId=<?php echo $row['piece_id'] ?>" ><i class="bi bi-eye"></i><!-- <?php echo language('SHOW', $_SESSION['systemLang']).' '.language('PIECES', $_SESSION['systemLang']) ?> --></a>
                            <?php } ?>
                        </td>
                    </tr>
                <?php } ?>
