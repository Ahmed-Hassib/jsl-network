    ...
    <div class="modal-dialog modal-dialog-centered modal-type-dialog" >
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="?do=showConnectionTypes&action=insertPieceConnType" method="POST" id="addPieceConnType">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary py-1 px-5 fs-12" form="addPieceConnType" onclick="validateForm(this.form)"><?php echo language("ADD", $_SESSION['systemLang']) ?></button>
