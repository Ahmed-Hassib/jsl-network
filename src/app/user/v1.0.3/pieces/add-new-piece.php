...
<div class="container" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    ...
    <form class="custom-form need-validation" action="?do=insertPiece" method="POST" id="addPiece">
        ...
        <!-- submit -->
        <div class="hstack gap-3">
            <button type="button" form="addPiece" class="btn btn-primary text-capitalize bg-gradient fs-12 p-1 <?php echo $_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>" id="add-piece" <?php if ($_SESSION['pcs_add'] == 0) {echo 'disabled';} ?> onclick="validateForm(this.form)">
