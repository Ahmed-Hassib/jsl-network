...
// check the piece id 
$pieceIsExist = checkItem("`piece_id`", "`pieces`", $pieceid);
...
<div class="container" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    ...
    <header class="header mb-5">
        ...
        <h5 class="h5 text-capitalize text-secondary ">
            <a href="<?php echo $nav_up_level ?>pieces/index.php?do=editPiece&pieceid=<?php echo $pieceid ?>">
                <?php echo selectSpecificColumn("`piece_name`", "`pieces`", "WHERE `piece_id` = $pieceid")[0]['piece_name'] ?>
            </a>
        </h5>
            <?php if ($malIsExist == 0) { ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <!-- <td class="text-center">
                                ...
                                <a href="<?php echo $nav_up_level ?>pieces/index.php?do=editPiece&pieceid=<?php echo $row['client_id'];?>"><?php echo $clientnName ?></a>
                            </td> -->
