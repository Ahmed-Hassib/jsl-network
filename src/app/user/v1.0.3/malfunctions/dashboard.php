                        ...
                        <table class="table table-bordered  display compact table-style w-100">
                            ...
                            <tbody>
                                ...
                                foreach ($todayMal as $index => $mal) {
                                    // get client info
                                    $clientName     = $mal_obj->select_specific_column("`piece_name`", "`pieces`", "WHERE `piece_id` = ".$mal['client_id'])[0]['piece_name'];
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width: 100px">
                                            <a href="<?php echo $nav_up_level ?>pieces/index.php?do=editPiece&pieceid=<?php echo $mal['client_id'] ?>">
