...
$pcs_counter = $db_obj->count_records("`piece_id`", "`pieces`", "WHERE `company_id` = ".$_SESSION['company_id']);
?>
<!-- start add new user page -->
<div class="container" dir="<?php echo $_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    <!-- start form -->
    <form class="custom-form" action="?do=insertMalfunctions" method="POST" id="addMalfunction">
        <!-- horzontal stack -->
                ...
                <div class="section-block">
                    ...
                    <div class="mb-sm-2 mb-md-3 row">
                        ...
                        <div class="col-sm-12 col-md-8 position-relative">
                            ...
                            <input type="text" name="client-name" id="client-name" class="form-control w-100" placeholder="<?php echo language('ADMIN NAME', $_SESSION['systemLang']) ?>" onkeyup="search(this)" data-company-id="<?php echo $_SESSION['company_id'] ?>" required  <?php if ($pcs_counter == 0) { echo 'disabled'; } ?> />
        ...
        <div class="hstack gap-3">
            <div class="<?php echo $_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
                <button type="button" form="addMalfunction" class="btn btn-primary text-capitalize form-control bg-gradient fs-12 <?php if ($_SESSION['mal_add'] == 0 || $emp_counter == 0 || $pcs_counter == 0) {echo 'disabled';} ?>" id="add-malfunctions" onclick="validateForm(this.form)">
