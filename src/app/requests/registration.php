            ...
            <?php
                ...
                if (!$is_exist_company_name) {
                    ...
                    if ($is_inserted_company) {
                        ...
                        echo '<div class="alert alert-success text-capitalize fw-bolder">' . language("YOUR COMPANY IS CREATED SUCCESSFULLY!") . '</div>';
                        ...
                        if ($is_inserted_license) {
                            ...
                            // echo success message
                            echo '<div class="alert alert-success text-capitalize fw-bolder">' . language("ONE MONTH FREE SUBSCRIPTION ACTIVATED SUCCESSFULLY!") . '</div>';
                            ...
                            if (!$is_exist_admin_username && $is_inserted_company && $is_inserted_license) {
                                ...
                                // insert admin info
                                $admin_info_query = "INSERT INTO `users` (`company_id`, `UserName`, `Pass`, `Fullname`, `isTech`, `gender`, `TrustStatus`, `addedBy`,  `joinedDate`, `systemLang`) VALUES (?, ?, ?, ?, 0, ?, 1, 1, now(), 0)";
                                ...
                                if ($is_inserted_admin_info) {
                                    // success message
                                    echo '<div class="alert alert-success text-capitalize fw-bolder">' . language("YOUR ADMIN ACCOUNT IS CREATED SUCCESSFULLY!") . '</div>';
                                    ...
                                    if ($is_inserted_admin_permission) {
                                        // success message
                                        echo '<div class="alert alert-success text-capitalize fw-bolder">' . language("YOUR ADMIN ACCOUNT PERMISSIONS IS CREATED SUCCESSFULLY!") . '</div>';
                                        // success message
                                        echo '<div class="alert alert-success text-capitalize fw-bolder">' . language('YOU WILL BE AUTOMATICALLY REDIRECTED AFTER') . " 3 " . language('SECOND') . '</div>';
                                        // redirect page
                                        header("refresh: 3;url=../login.php?username=$username&password=$password");
                                        exit();
                                    } else {
                                        // failed message
                                        echo '<div class="alert alert-danger text-capitalize fw-bolder">' . language('ADMIN PERMISSION IS NOT INSERTED PLEASE, TRY AGAIN OR CALL TECH SUPPORT!') . '</div>';
                                    ...
                                    // failed message
                                    echo '<div class="alert alert-danger text-capitalize fw-bolder">' . language('ADMIN IS NOT INSERTED PLEASE, TRY AGAIN OR CALL TECH SUPPORT!') . '</div>';
                                ...
                                // failed message
                                echo '<div class="alert alert-danger text-capitalize fw-bolder">' . language('THIS USERNAME IS ALREADY EXIST') . '</div>';
                            ...
                            // failed message
                            echo '<div class="alert alert-danger text-capitalize fw-bolder">' . language('LICENSE IS NOT INSERTED PLEASE, TRY AGAIN OR CALL TECH SUPPORT!') . '</div>';
                        ...
                        // failed message
                        echo '<div class="alert alert-danger text-capitalize fw-bolder">' . language('COMPANY IS NOT INSERTED PLEASE, TRY AGAIN OR CALL TECH SUPPORT!') . '</div>';
                    ...
                    // success message
                    echo '<div class="alert alert-danger text-capitalize fw-bolder">' . language('COMPANY NAME IS ALREADY EXIST!') . '</div>';
