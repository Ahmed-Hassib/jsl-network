                ...
                <?php foreach ($companies as $company) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-outline-primary fs-12 renew-license-btn" data-bs-toggle="modal" data-bs-target="#renewLicenseModal"><i class="bi bi-arrow-clockwise"></i></button>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
