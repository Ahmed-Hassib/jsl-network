...
class PiecesConn extends Database {
    ...
    // get all types_conn
    public function get_all_conn_types($company) {
        // get all pieces types_conn
        $typesQuery = "SELECT *FROM `conn_types` WHERE `company_id` = ?";
    ...
    public function insert_new_conn_type($name, $note, $company) {
        // insert query
        $insertQuery = "INSERT INTO `conn_types` (`conn_name`, `notes`, `company_id`) VALUES (?, ?, ?);";
    ...
    public function update_conn_type($name, $note, $id) {
        // insert query
        $updateQuery = "UPDATE `conn_types` SET `conn_name` = ?, `notes` = ? WHERE `id` = ?";
    ...
    public function delete_conn_type($id) {
        // delete query
        $deleteQuery = "DELETE FROM `conn_types` WHERE `id` = ?";
