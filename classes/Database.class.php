...
class Database extends PDO {
    ...
    /** METHODS */
    // constructor
    public function __construct ($host = "localhost", $name = "jsl_db", $user =  "root", $pass = "@hmedH@ssib") {
    ...
    public function get_next_id($table) {
        // prepare query
        $stmt = $this->con->prepare("SELECT `AUTO_INCREMENT` AS 'AI' FROM information_schema.TABLES WHERE `TABLE_SCHEMA` = 'jsl_db' AND `TABLE_NAME` = ?");
